...
function getTemplateForSubscription() {
    const template = `<html>
    <body style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size: 12px; background: #E6E6FA; padding: 15px;">
        <h3> Dear Subscriber,</h3>
        <div>
            <h4>
                You have been subscribed successfully for R-Shop Updates!
            </h4>
            <p>
                You will receive all our latest updates periodically. 
            </p>
            <p>
                Thanks, <br>
                Anil Vishvkarma <br>
...
function getTemplateForFeedback(userEmail, userName, message) {
    const template = `<html>
    <body style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size: 12px; background: #E6E6FA; padding: 15px;">
        <h3> Dear Rshop Executive,</h3>
        <div>
            <p>
               ${message}
            </p>
...
module.exports = {
    ...
    getTemplateForSubscription,
    getTemplateForFeedback
};