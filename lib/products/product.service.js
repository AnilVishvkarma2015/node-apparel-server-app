...
function getBarcodeByNameAndBrand(productParams) {
    return Product.find({ productName: productParams.productName, productBrand: productParams.productBrand });
}
